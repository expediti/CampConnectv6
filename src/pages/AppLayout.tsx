  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0a] to-[#1a1a2e] text-white flex flex-col">
      ...
      <div className="flex flex-1 relative min-h-screen">
        ...
        <aside className={`fixed md:static w-64 bg-[#1e293b] border-r border-gray-800 min-h-full p-4 z-30 transition-transform duration-300 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
