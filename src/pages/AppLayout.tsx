  ...
  const sendMessage = async () => {
    ...
    const { error } = await supabase
      ...
      .insert([{
        ...
        title: newMessage.trim().slice(0, 100), // Use first 100 chars as title
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0a] to-[#1a1a2e] text-white">
      ...
      <div className="flex relative">
        ...
        <main className="flex-1 p-4 md:p-8 max-w-4xl mx-auto w-full pb-24">
          ...
          {view === 'chat' && currentCommunity && (
            <div className="flex flex-col h-[calc(100vh-200px)]">
              ...
              <button
                ...
                className="fixed bottom-6 right-6 bg-green-600 hover:bg-green-700 text-white w-14 h-14 rounded-full shadow-2xl transition-all hover:scale-110 z-40 flex items-center justify-center text-2xl"
                title="Send Message"
              >
                💬
              </button>
          ...
          {/* Create Community - NO INITIAL THREAD */}
          {view === 'create' && (
            <div>
